...
Public Class NewBusiness
    ...
    Private Sub NewBusiness_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        'Next line gets all businesses and filters out duplicates that are from groupings
        Dim strID As String = baseform.frmCalling
...
JUMP:   Loop
    ...
    Private Sub dgvAccounts_RowEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs)
