...
Public Class rptDetail
    ...
    Private Sub rptDetail_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        strSql += " from tblDRJournal a, tblDRCOA b, tblBusiness c "

        strSql += "where b.actNum = a.jnlActNum and a.jnlActSeq = b.actNumSeq "
        strSql += "And a.jnlTranBusinessID =c.busID "
        strSql += "and b.actNum = " & strAccount
        If Len(actID) > 4 Then
