...
Public Class rptIncExp_BU
    ...
    Sub DisplayGrid()
        ...
        strSql &= " and a.jnlActNum > 3999 group by a.jnlActNum, a.jnlActSeq, b.actName, b.actTypeName, actDescription"
        ...
        Do While dr.Read()
            ...
            If aRecord <> bRecord Then 'Startin a new account type
                ...
                If n > 0 Then 'If its not the first row then it starts a new account type
                    ...
                    'dgvAccounts.Rows.Item(n).Cells(2).Style.SelectionForeColor = Color.Black
